...
| `pinSideSources`       | `Boolean`        | Optional  | `true`              | In multiview (split view), pin each side tile to its lowest-bitrate encoding. Set to `false` to let server-side ABR choose the layer for the tiles.                     |
