...
| `hideToast`   | `String`          | Optional |  `null`              | Allows to hide a specific type of toast, with the capability to hide multiple types simultaneously by `,`. Accepted values: 'success', 'error', 'warning', 'info'. |
