    ...
    <div id="chat-container" class="card">
      <div class="card-header msg-head">
        <div class="d-flex bd-highlight">
          <div class="img-cont">
            <div class="header-profile-image d-flex align-items-center justify-content-center">
      ...
      <div class="card-body msg-card-body">
        <div v-for="message in messages" :key="message.id" class="d-flex mb-4" :class="messageAligne(message.userName)">
      ...
      <div class="card-footer">
        <div class="input-group">
          ...
          <input id="text-msg" type="text" v-model="textMsg" @keyup.enter=publishSampleMessage class="form-control" placeholder="Type your message...">
          <div class="input-group-append">
            <button id="send-btn" @click=publishSampleMessage class="input-group-text">
