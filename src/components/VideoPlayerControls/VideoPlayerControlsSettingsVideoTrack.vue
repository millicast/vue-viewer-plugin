<template>
    ...
    >
        ...
        <div
            ...
            :class="[
                this.selectedVideoSource.name === 'none' ? 'none' : '',
                this.selectedVideoSource.sourceId === null ? 'main' : '',
            ]"
        >
            <span
                v-if="unsupportedFlagEmoji(this.selectedVideoSource.name)"
                v-html="sourceFlagEmojiToPng(this.selectedVideoSource.name)"
            ></span>
