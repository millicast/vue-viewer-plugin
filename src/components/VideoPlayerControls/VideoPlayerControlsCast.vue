<template>
  <div :class="[isMobile ? 'dropdown-item d-flex row mx-0' : 'mobile-setting']" v-if="castAvailable && !options.loading"
    @click="clickCast">
      <div :class="[isMobile ? '' : 'mobile-setting']">
        <i class="align-middle control-icon" :class="isMobile ? 'mobile-icon': 'h3'">
